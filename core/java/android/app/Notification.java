...
public class Notification implements Parcelable
{
    ...
    public static class Builder {
        ...
        private void processSmallIconColor(Icon smallIcon, RemoteViews contentView,
            ...
            int color;
            if (ambient) {
                color = mContext.getSystem().getBoolean(R.bool.config_allowNotificationIconTextTinting) ? resolveAmbientColor() : mContext.getColor(R.color.system_notification_accent_color);
            } else if (isColorized()) {
                color = getPrimaryTextColor();
            } else {
                color = mContext.getSystem().getBoolean(R.bool.config_allowNotificationIconTextTinting) ? resolveContrastColor() : mContext.getColor(R.color.system_notification_accent_color);
            }
            if (colorable) {
        ...
        int resolveContrastColor() {
            if (!mContext.getSystem().getBoolean(R.bool.config_allowNotificationIconTextTinting)) {
